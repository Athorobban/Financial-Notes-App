...
export default function Transaction() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-8">
      <TransactionTable transactions={data} isLoading={isLoading} refetch={refetch} page={page} limit={limit} search={search} setPage={setPage} setLimit={setLimit} setSearch={setSearch} />
