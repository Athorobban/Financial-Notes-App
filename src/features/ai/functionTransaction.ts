...
const transactionProperties = {
  ...
  category: {
    type: Type.STRING,
    enum: ["Food & Drink", "Shopping", "Housing", "Transportation", "Entertainment", "Salary", "Others"],
    description: "The category of the transaction",
  },
  description: {
    type: Type.STRING,
    description: "A brief description of the transaction, first letter capitalized",
  },
  date: {
    type: Type.STRING,
...
export const createTransactionDeclaration: FunctionDeclaration = {
  ...
  description: "Create a new transaction in the user's financial history based on the provided details.",
  parameters: {
    type: Type.OBJECT,
    properties: transactionProperties,
...
export const deleteTransactionDeclaration: FunctionDeclaration = {
  ...
  description: "Delete an existing transaction from user's financial history based on the provided data.",
  parameters: {
    type: Type.OBJECT,
    properties: transactionProperties,
  },
